    ...
    <main className="min-h-screen bg-gradient-to-b from-green-50 to-white py-8">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-green-800">Dyoal</h1>
          <p className="mt-2 text-lg text-gray-600">Dynamic Crop Lifecycle Calendar</p>
...
export default function DyoalPage() {
  return (
    <ProtectedRoute>
      <DyoalContent />
    </ProtectedRoute>
